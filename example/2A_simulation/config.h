...
#define RVF_NSAMPLES 100                    // Define the number of scenarios/independent optimisations to run.
...
#define RVF_WRITE_SUMMARY 1                 // Should summary values (sum across ages) of all compartments be written?
...
#define RVF_OPTIMISE 0                      // Define whether we will optimise a defined summary metric over a given set of parameters.
#define RVF_OPTIM_RUNS 500                  // The number of optimisation runs to make.
#define RVF_OPTIM_NCOST 50                  // The number of repeats of the cost function to take.
#define RVF_OPTIM_NPARTICLES 100            // The number of particles to use per optimisiation run.
